  ...
  app.get("*", async (req, res, next) => {
    ...
    try {
      ...
      if (startIndex !== -1 && endIndex !== -1) {
        const customMeta = getMetaTagsForPath(url);
 ...
 */
function getMetaTagsForPath(urlPath: string): string {
  ...
  if (pathname === '/helolex' || pathname.startsWith('/helolex')) {
    ...
    <meta property="og:url" content="https://korlyn-helolex.onrender.com/helolex" />
  ...
  if (pathname === '/admin' || pathname.startsWith('/admin')) {
    ...
    <meta property="og:url" content="https://korlyn-helolex.onrender.com/admin" />
    <meta property="og:site_name" content="KORLYN &amp; HELOLEX Protocol" />
  ...
  if (pathname === '/print-certificate' || pathname.startsWith('/print-certificate')) {
    ...
    <meta property="og:image" content="https://raw.githubusercontent.com/Joweb1/Jovibe-images/main/korlyn_cube_illustration.jpg" />
    <meta property="og:url" content="https://korlyn-helolex.onrender.com/print-certificate" />
    <meta property="og:site_name" content="KORLYN &amp; HELOLEX Protocol" />
  ...
  // Default to KORLYN Home Platform
  return `    <title>KORLYN | Your Premium Platform for Digital Assets &amp; Direct Payments</title>
    ...
    <meta property="og:image" content="https://raw.githubusercontent.com/Joweb1/Jovibe-images/main/korlyn_cube_illustration.jpg" />
    <meta property="og:url" content="https://korlyn-helolex.onrender.com/" />
    <meta property="og:site_name" content="KORLYN &amp; HELOLEX Protocol" />
    <meta property="og:image:alt" content="The KORLYN Premium Monolithic Product Cube" />
